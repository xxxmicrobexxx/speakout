			...
			<table class="form-table">
				...
				<tr>
					...
					<td>
						...
						<label for="speakout-editor-markdown"><input type="radio" name="speakout_editor" id="speakout_editor-markdown" value="markdown" <?php if ( $the_settings->speakout_editor != 'html' ) echo 'checked="checked"'; ?> /> <?php _e( 'Markdown', 'speakout' ); ?> <a href="https://speakoutpetitions.com/markdown-guide/ target="_blank">(deprecated)</a></span></label>
					</td>
				</tr>
				<tr>
